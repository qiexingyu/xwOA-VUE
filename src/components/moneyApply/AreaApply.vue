          ...
          <table cellpadding="0" cellspacing="0" border="1">
            ...
            <tbody v-for="(vi, vk) in tableData">
              <tr v-for="(vr, vu) in vi.sun">
                ...
                <td>{{ vr.c2 }}</td>
                <td>{{ (vr.c1==2)?(vr.c13.join(",")):vr.c5 }}</td>
                <td>{{ (vr.c1!=2)?vr["c8"]:'N/A' }}</td>
                <td>{{ vr.c9.edval }}</td>
                <td>{{ vr.c10 }}</td>
                <td>{{ vr.c11 }}</td>
              </tr>
...
export default {
  ...
  methods: {
    ...
    subPersonApply: function(){            //提交
      ...
      $.ajax({
        url: this.path + "insertAreaPlanning",
        type: "post",
        dataType: "json",
        data: subApplyData,
        success: function(data){
    ...
    getSelectCostType: function(){
      this.dropData.monTypeList = this.OACommon.selectCostType();
    },
    ...
    getProvinceList: function(){
      var pList = this.OACommon.findProvinceList(this.searchData.areaVal);
      pList.shift();
      this.dropData.provinceList = pList;
    },
