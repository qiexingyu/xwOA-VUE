   ...
   <div class="roleManagement">
      ...
      <div class="gonggao_body table_body" style="padding-top: 20px">
        ...
        <div class="baoxiao" style="width: 100%;text-align: center;padding: 20px 10px" >
             <span style="font-size: 25px;font-weight: 700">{{ dateTime }}费用对比情况</span>
        ...
        <div class="money_table">
          <table cellpadding="0" cellspacing="0" border="1" style="text-align: center">
              ...
              <tbody v-for="(list,v) in tableList">
                  <tr>
                  ...
                  <tr v-for="(proList,k) in list.provinceList">
                    <td v-bind:rowSpan="proList.rowspan">{{ proList.provinceName }}</td>
                    <td>省份总计</td>
    ...
    export default {
        ...
        methods:{
                      ...
                      if(data.code == 200){
                        if(this.tableList[v].provinceList[k].check == "1"){
                           ...
                           for(var i=0;i<data.data.length;i++){
                            ...
                            this.tableList[v].rowspan = Number(this.tableList[v].rowspan) + Number(this.tableList[v].provinceList[k].rowspan) + Number(1);                           
            ...
            getLeft: function(){
              ...
              $.ajax({
              type : "post",
              url : this.path + "selectUserCostStaticByCostCategoryAndAreaId",
              data : {
                "jobNumber": localStorage.getItem("jobNumber"),
                "sessionIdOa": localStorage.getItem("sessionIdOa"),
                "timeString": this.timeString,
