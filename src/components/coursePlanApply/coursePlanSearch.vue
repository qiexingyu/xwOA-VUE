    ...
    <div class="gonggao_bread">
      ...
      <div class="search_div">
        <div class="yydo">
          ...
          <select v-model="searchData.areaVal" v-on:change="areaChange">
      ...
      <div class="gonggao_body table_body">
        <div class="data_table_head">
          <ul>
            ...
            <li class="td8">申请人</li>
            <li class="td11">上课时间</li>
            <li class="td9" style="padding-left:5px;">课程类型</li>
            <li class="td7">年级</li>
            <li class="td7">科目</li>
            <li class="td7">省份</li>
        ...
        <div class="data_table_body">
          <ul v-for="(l, i) in list" v-if="list.length>0">
            ...
            <li class="td11">{{ l.learnDate }}</li>
            <li class="td9" style="padding-left:5px;">{{ keType[l.courseTypeId] }}</li>
            <li class="td7">{{ l.grade }}</li>
      ...
      <div class="kecha_pop" style="height:500px;" v-if="viewData.isShow">
        ...
        <table cellpadding="0" cellspacing="0" border="1">
          ...
          <tr class="x">
            <td class="b" width="12%">省份</td>
            <td width="9%">{{ viewData.vdata.provinceName }}</td>
            <td class="b" width="12%">学校</td>
            <td width="11%">{{ viewData.vdata.schoolName }}</td>
            <td class="b" width="12%">省份负责人</td>
          ...
          <tr class="x">
            <td class="b">学校负责人</td>
            <td>{{ viewData.vdata.customerContactsName }}</td>
            <td class="b">学校负责人电话</td>
            <td>{{ viewData.vdata.contactsPhone }}</td>
            <td class="b">邮箱</td>
            <td>{{ viewData.vdata.contactsEmail }}</td>
            <td class="b">上课科目</td>
          ...
          <tr class="x">
            ...
            <td class="b">教材版本</td>
            <td colspan="5">{{ viewData.vdata.textbookVersion }}</td>
            <!--<td class="b">每人或每天收费</td>
            <td>{{ viewData.vdata.oneDayMoney }}</td>
            <td class="b">回款日期</td>
            <td>{{ viewData.vdata.returnedMoneyDate }}</td>-->
          </tr>
          <tr class="x">
            <td class="b">行程安排</td>
            <td colspan="7">{{ viewData.vdata.scheduling }}</td>
          </tr>
          <tr class="x">
            <td class="b">学生层次</td>
...
export default {
  ...
  methods: {
    ...
    areaChange: function(){
      this.searchData.province = this.OACommon.findProvinceList(this.searchData.areaVal);
    },
    getList: function(pn, ps){
      ...
      $.ajax({
        url: this.path + "findCourseScheduleApplyListPage",
        type: "post",
        dataType: "json",
        data: {
          "jobNumber": localStorage.getItem("jobNumber"),
